...
export async function action({ request }: ActionFunctionArgs) {
  ...
  // eslint-disable-next-line array-func/prefer-array-from, unicorn/no-array-for-each
  ...
  console.log('buecher:', buchData?._embeddedd?.buecher);

  return buchData?._embedded?.buecher || 1;
}
