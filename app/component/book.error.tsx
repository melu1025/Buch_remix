import { Flex, Alert, AlertDescription, AlertIcon, AlertTitle } from "@chakra-ui/react";
...
export default function BookError({
    ...
    case 403: {
        ...
        alertDescription = "Bitte melden Sie sich zuerst an. Vorher kann kein neues Buch angelegt";
    ...
    case 500: {
        ...
        alertDescription = "Bitte versuchen Sie es später noch einmal. Vielen Dank";
